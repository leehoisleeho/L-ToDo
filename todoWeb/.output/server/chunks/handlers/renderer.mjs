...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width,initial-scale=1,minimum-scale=1,maximum-scale=1,user-scalable=no,viewport-fit=cover"},{"name":"description","content":"todoList"},{"name":"keywords","content":"todo 效率"}],"link":[],"style":[],"script":[],"noscript":[],"title":"L-ToDo"};
